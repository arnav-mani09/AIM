    ...
    <main className="mx-auto flex min-h-screen w-full max-w-5xl flex-col gap-8 px-6 py-12">
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <button
          ...
          className="self-start rounded-full border border-stroke px-4 py-2 text-sm font-semibold text-[#0e1a2e]"
        >
          Sign out
        </button>
      </header>
                ...
                <li key={clip.id} className="rounded-2xl border border-stroke p-4">
                  <div className="flex items-center justify-between gap-3">
                    ...
                    >
                      ...
                      <p className="text-xs text-subtext">
                        Uploaded {new Date(clip.uploaded_at).toLocaleString()}
                      </p>
                    </Link>
                    <div className="flex items-center gap-2">
                      <span className="rounded-full bg-[#ecf2fb] px-3 py-1 text-xs text-[#0e1a2e]">
      ...
      <section className="section-card space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <form onSubmit={handleCreateTeam} className="flex flex-col gap-3 rounded-2xl border border-dashed border-stroke p-4 text-sm">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <form onSubmit={handleCreateInvite} className="flex flex-col gap-3 rounded-2xl border border-stroke p-4 text-sm">
            ...
            <label className="flex flex-col gap-1">
              Expires in hours
              <input name="expires" type="number" min={1} className="rounded-xl border border-stroke px-3 py-2 text-[#0e1a2e]" />
            </label>
            <label className="flex flex-col gap-1">
              Max uses
              <input
